...
namespace OpenCVForUnitySample
{
		...
		public class MultiObjectTrackingBasedOnColorSample : MonoBehaviour
		{
                ...
                /// <summary>
                /// The buf for storing button text
                /// </summary>
                public Text text;
                ...
                public void OnPauseCameraButton ()
                {
                        webCamTexture.Pause();
        ...
        void drawObject (List<ColorObject> theColorObjects, Mat frame, Mat temp, List<MatOfPoint> contours, Mat hierarchy)
				{
						...
						for (int i = 0; i < theColorObjects.Count; i++) {
								...
								Core.circle (frame, new Point (theColorObjects [i].getXPos (), theColorObjects [i].getYPos ()), 5, black /*theColorObjects [i].getColor ()*/);
								...
								Core.putText (frame, theColorObjects [i].getType (), new Point (theColorObjects [i].getXPos () - 1, theColorObjects [i].getYPos () - 21), 1, 2.1, black/*theColorObjects [i].getColor ()*/, 2);
                                Core.putText (frame, theColorObjects [i].getType (), new Point (theColorObjects [i].getXPos (), theColorObjects [i].getYPos () - 20), 1, 2, white/*theColorObjects [i].getColor ()*/, 2);
            }
				}
